...
def get_coco_annotation_from_obj(obj, label2id, category):
...
def convert_xmls_to_cocojson(annotation_paths: List[str],
    ...
    for a_path in tqdm(annotation_paths):
        ...
        for obj in ann_root.findall('object'):
            ann = get_coco_annotation_from_obj(obj=obj, label2id=label2id, category=category)
            if not ann:
                continue
...
def main():
    ...
    parser.add_argument('--category',type=int,default=0,help='category to train on')
